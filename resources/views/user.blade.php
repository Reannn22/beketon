        ...
        <div class="rounded-lg">
            ...
            <div class="flex flex-col justify-around gap-4 mx-10 -mt-36 mb-4 p-8 rounded-xl bg-white">
                <div class="flex flex-col gap-3 justify-start items-start p-8 lg:p-0">
                    ...
                    <button data-modal-target="adduser-modal" data-modal-toggle="adduser-modal" class="font-medium text-white bg-[#A4C639] px-6 py-2 rounded-lg" type="button">
                        Tambah User
                    </button>
                </div>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="adduser-modal">
                ...
                <form action="{{ route('users') }}" method="POST">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="John Smith" required />
                        </div>
                        <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="*********" required />
                        </div>
                        <div class="mb-5">
