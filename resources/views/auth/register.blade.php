            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="/register">
                        ...
                        <div>KTP atau KTM (PDF)
                            <label for="KTP" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"></label>
                            <input type="file" name="ktp" id="ktp" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full  " placeholder="file.pdf" required="">
                        </div>
                        <div>
                        ...
                        <div class="text-sm">
                            <label>
                                <input type="checkbox" name="terms" required>
                                    Saya setuju dengan <span class="text-blue-600"><a  href="/kebijakan" target="_blank">kebijakan dan ketentuan</a></span> yang berlaku.
                            </label>
                        </div>                     
                        <button type="submit" class="w-full text-white bg-[#50790B] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            Create an account
                        </button>
