        ...
        <div class="h-full flex flex-col justify-normal px-4 py-12 overflow-y-auto bg-gray-50">
            ...
            @if (auth()->user()->role === 'admin')
                <ul class="space-y-2 py-4 font-medium">
                    <li>
                        <a href="#" class="flex items-center p-2 text-white rounded-lg bg-primary group">
    ...
    <div class="sm:ml-64 bg-[#EEEEEE] pb-5">
        <div class="rounded-lg">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-{{ auth()->user()->role === ('user') ? '2' : '3' }} gap-8 mb-4 mx-10">
                @if (auth()->user()->role === 'admin')
                    <div
                        class="flex flex-col lg:flex-row gap-3 lg:gap-0 items-center justify-around p-6 rounded-lg bg-secondary">
            ...
            <div class="grid py grid-cols-1 lg:grid-cols-2 gap-8 mb-4 mx-10 ">
                <div
                    class="flex flex-col items-center justify-center rounded-lg gap-4 bg-gray-50 p-16 group hover:bg-primary cursor-pointer">
                    <div class="bg-primary p-6 rounded-full group-hover:bg-white">
                        <svg width="48" height="48" viewBox="0 0 62 62" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path class="fill-white group-hover:fill-primary"
                    ...
                    <div class="flex flex-col justify-center items-center gap-3">
                        ...
                        <a href="{{ route('pinjamBarang') }}"
                            class="text-xl text-secondary group-hover:text-white group-hover:underline font-bold">
                            Klik Disini
                        </a>
                    </div>
                </div>
